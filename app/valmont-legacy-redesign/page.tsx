...
export const metadata: Metadata = {
  ...
  description: "Five legacy enterprise apps modernised into one unified web experience — redesigned information architecture, component library, and role-based dashboards.",
  openGraph: {
    title: "Valmont Legacy Redesign — Case Study",
    description: "Five legacy enterprise apps modernised into one unified web experience — redesigned information architecture, component library, and role-based dashboards.",
    type: "article",
    images: [{ url: "/casestudy/images/redesign/hero.webp", width: 1200, height: 630, alt: "Valmont Legacy Redesign — Enterprise Case Study" }],
  },
};
  ...
  return (
    <section className="max-w-7xl mx-auto mb-32">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
        ...
        <div className="lg:col-span-7 order-1 lg:order-2"><ScrollReveal direction="right"><div className="rounded-xl overflow-hidden"><Image src="/casestudy/images/redesign/hero.webp" alt="Valmont Industries — AG Portal" width={1200} height={750} className="w-full h-auto block" /></div></ScrollReveal></div>
      </div>
    </section>
  );
}
...
function Applications() {
  const apps = [
    {n:"01",name:"AG Portal",sub:"Central launchpad for Valmont's internal applications",before:"/casestudy/images/redesign/ag%20portal%20-before.webp",after:"/casestudy/images/redesign/ag%20portal%20-after.webp",changes:[{b:"Image-card nav, no hierarchy",a:"Icon card launcher grid"},{b:"No search or filtering",a:"Global search + region tabs"},{b:"No brand alignment",a:"Valley brand system applied"},{b:"No personalisation",a:"Favourite App feature"}],insight:"The portal redesign set the tone for the entire suite — establishing the Valley brand header, navigation patterns, and component language used across all five applications."},
    {n:"02",name:"SPIN II",sub:"Production planning tool — scheduling data and planner management",before:"/casestudy/images/redesign/spin%20-%20before.webp",after:"/casestudy/images/redesign/spin%20-%20after.webp",changes:[{b:"Plain instruction text, no nav",a:"Valley header + tabbed nav"},{b:"Unstyled table, raw delete links",a:"Sortable grid + pagination"}],insight:null},
    {n:"03",name:"Security App",sub:"User access, roles, and permissions management across Valmont's systems",before:"/casestudy/images/redesign/Security%20App-%20beforev.webp",after:"/casestudy/images/redesign/Security%20App-%20After.webp",changes:[{b:"Heavy green Windows-era UI",a:"Valley header + clean white"},{b:"Raw table + arrow transfer widget",a:"Structured sidebar + card grid"}],insight:"One of the most complex redesigns — managing nested permission structures required careful IA to keep all controls accessible without overwhelming administrators."},
    {n:"04",name:"SOS — Schedule of Supply",sub:"Weekly supply scheduling across production sites",before:"/casestudy/images/redesign/SOS%20-%20Before.webp",after:"/casestudy/images/redesign/v.webp",changes:[{b:"Dense spreadsheet, yellow headers",a:"Clean 5-week grid, Valley brand"},{b:"Tiny controls, no breathing room",a:"Spacious dropdowns + slot counters"}],insight:null},
    {n:"05",name:"OJV — Order Jacket Viewer",sub:"Order documentation lookup and management",before:"/casestudy/images/redesign/ojv%20-%20before.webp",after:"/casestudy/images/redesign/ojv%20-%20after.webp",changes:[{b:"Old Valmont Irrigation blue blocks",a:"Unified Valley header + DB selector"},{b:"Raw table, VIEW/Delete text links",a:"Sortable columns + pagination"}],insight:null},
  ];
  return (
