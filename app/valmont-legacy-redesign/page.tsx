    ...
    <div className="px-8 md:px-20 mb-32"><div className="max-w-7xl mx-auto"><div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-0">
      ...
      <div className="lg:col-span-9">
        <ScrollReveal delay={100}>
          ...
          <div className="grid grid-cols-4 gap-px bg-[var(--color-border)]">{[{n:"5",l:"Apps Redesigned"},{n:"50+",l:"Screens Designed"},{n:"3+",l:"Years Embedded"},{n:"1",l:"Unified Design System"}].map(s=><div key={s.l} className="bg-[var(--color-bg)] px-6 py-8"><p className="text-5xl font-black tracking-tighter text-[var(--color-text-primary)] mb-2">{s.n}</p><p className="text-sm text-[var(--color-text-muted)]">{s.l}</p></div>)}</div>
        </ScrollReveal>
      </div>
    </div></div></div>
  );
  ...
  return (
    <div className="py-24 bg-[var(--color-bg-alt)]"><div className="px-8 md:px-20"><div className="max-w-7xl mx-auto"><div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-0 mb-16">
      ...
      <div className="lg:col-span-9">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">{phases.map((p,i)=><ScrollReveal key={p.n} delay={i*80}><div className={`p-6 rounded-xl ${p.hl?"bg-[var(--color-accent-warm)] text-white":"bg-[var(--color-surface)]"}`}><span className={`text-[10px] font-bold uppercase tracking-widest ${p.hl?"text-white/60":"text-[var(--color-accent-warm)]"}`}>{p.n}</span><h3 className="font-bold text-base mt-2 mb-2">{p.t}</h3><p className={`text-sm leading-relaxed ${p.hl?"text-white/70":"text-[var(--color-text-secondary)]"}`}>{p.d}</p></div></ScrollReveal>)}</div>
      </div>
    </div></div></div></div>
  );
}
  ...
  return (
    <div className="px-8 md:px-20 py-32"><div className="max-w-7xl mx-auto">
      ...
      {apps.map((app,i)=><ScrollReveal key={app.n} delay={i*100}><div className={`mb-24 ${i<apps.length-1?"pb-24 border-b border-[var(--color-border)]":""}`}>
        <div className="flex items-center gap-4 mb-10"><div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-black text-sm flex-shrink-0 bg-[var(--color-accent-warm)]">{app.n}</div><div><h3 className="font-bold text-2xl">{app.name}</h3><p className="text-sm text-[var(--color-text-muted)]">{app.sub}</p></div></div>
    ...
    <div className="py-24 bg-[var(--color-bg-alt)]"><div className="px-8 md:px-20"><div className="max-w-7xl mx-auto"><div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-0">
      ...
      <div className="lg:col-span-9">
        <ScrollReveal delay={100}>
          ...
          <div className="grid grid-cols-4 gap-px bg-[var(--color-border)] mb-16">{[{n:"5",l:"Apps Unified"},{n:"50+",l:"Screens"},{n:"1",l:"Design System"},{n:"100%",l:"Dev-Ready"}].map(s=><div key={s.l} className="bg-[var(--color-bg)] px-6 py-8"><p className="text-5xl font-black tracking-tighter text-[var(--color-text-primary)] mb-2">{s.n}</p><p className="text-sm text-[var(--color-text-muted)]">{s.l}</p></div>)}</div>
