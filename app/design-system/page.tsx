...
export default function DsPage() {
  return (
    <main className="pt-32 pb-24">
      <CaseStudyJsonLd title="Valley Design System" description="A production-ready design system bridging design and engineering — design tokens, component library, and governance guidelines that scaled consistency across 5+ enterprise products." slug="design-system" />
